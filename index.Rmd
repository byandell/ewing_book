...
description: "This is a bookdown version of Quantitative Population Ethology inspired by writing of Bland Ewing. The output format for this example is bookdown::gitbook."
---
...
```
Bland Ewing, Paradise, CA
Brian S.~ Yandell, University of Wisconsin--Madison, WI
James F.~Barbieri, Advanced Systems Development, NAWC-WPNS, China
Lake, CA
Robert F. Luck, University of California, Riverside, CA
Lisa D. Forster, University of California, Riverside, CA
11 Dec 2001
```


Bland Ewing$^1$, Brian S. Yandell$^2$, James F. Barbieri$^{3,4}$, Robert
F. Luck$^3$ and Lisa D. Forster$^3$

$^1$Scientist, Paradise, CA
...
$^4$Advanced Systems Development, NAWC-WPNS, China Lake, CA
